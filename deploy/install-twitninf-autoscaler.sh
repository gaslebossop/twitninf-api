...
set_autoscaler_default AUTOSCALE_LOW_STREAK 36
set_autoscaler_default AUTOSCALE_IN_COOLDOWN_SECONDS 120
set_autoscaler_default AUTOSCALE_WINDOW_SECONDS 15
set_autoscaler_default AUTOSCALE_WARMUP_SECONDS 1
set_autoscaler_default AUTOSCALE_MAX_REPLICAS 32
set_autoscaler_default AUTOSCALE_REPLICA_MEMORY_BUDGET_MB 1536
set_autoscaler_default AUTOSCALE_MAX_SCALE_OUT_BATCH 2
